...
class FinancialSymbolProcessorWrapper(QWidget):
    ...
    symbols_extracted = Signal(str, list)
    ...
    def __init__(self, project_config, parent=None):
        ...
        self._enabled = True
        self.processor = FinancialSymbolProcessor(config=self.config, project_config=project_config)
        self.setup_ui()
    ...
    def start(self, file_paths=None, **kwargs):
        ...
        self.worker_thread = FinancialSymbolWorkerThread(self.processor, file_paths, **kwargs)
        ...
        self.worker_thread.symbols_extracted.connect(self.symbols_extracted)
    ...
    def refresh_config(self):
        cfg = self.project_config.get('processors.specialized.symbols', {})
    ...
    def setup_ui(self):
        ...
        layout.addWidget(QLabel("Financial Symbol Processor UI"))
