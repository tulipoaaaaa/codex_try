...
class ApiCollector(BaseCollector):
    ...
    def __init__(self, output_dir, api_base_url=None, delay_range=(5, 10)):
...
if __name__ == "__main__":
    ...
    collector = ApiCollector(output_dir, api_base_url=api_base_url)
    params = None
    if args.params:
        try:
    ...
    print(f"Collected 1 API record. Output dir: {output_dir}")