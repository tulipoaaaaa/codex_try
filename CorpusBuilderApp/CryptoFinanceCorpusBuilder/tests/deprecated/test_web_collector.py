...
def collector(config):
    """Fixture to provide WebCollector instance"""
    return WebCollector(config)

def test_web_collector_projectconfig(config, collector):
    """Test WebCollector with ProjectConfig integration and real downloads"""
...
def test_web_collector_by_url(config, collector):
